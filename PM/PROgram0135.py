...
Q2) Write a Python program to implement a class named Circle with the
...
Define a constructor (__init__) that initializes all instance variables
to 0.0.
...
CalculateArea() - calculates the area of the circle and stores it
in the Area variable.

CalculateCircumference() - calculates the circumference of the circle
and stores it in the Circumference variable.
